...
cd GamingAgent
```
2. Install [uv](https://docs.astral.sh/uv/getting-started/installation/) if you haven't already, then install dependencies:
```
uv sync
```
...
To test the models yourself, copy `.env.example` to `.env` and fill in your API keys:
